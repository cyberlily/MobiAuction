...
@interface CategoryTableViewController : UIViewController <NSFetchedResultsControllerDelegate, UISearchBarDelegate> {
...
@property(readwrite, nonatomic, weak) IBOutlet CategoryTableViewCell *tableViewCell;
